...
import { FaChevronDown, FaCamera, FaZap } from 'react-icons/fa';
            ...
            <div className="animate-fade-in-up">
              <div className="mb-8">
                <div className="w-40 h-40 mx-auto mb-6 relative group">
                  ...
                  {/* Floating icons */}
                  <FaCamera className="absolute -top-2 -right-2 w-6 h-6 text-yellow-400 animate-sparkle" />
                  <FaZap className="absolute -bottom-2 -left-2 w-6 h-6 text-blue-400 animate-bounce animation-delay-500" />
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up animation-delay-1500">
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center text-lg">
                    <FaCamera className="w-5 h-5 mr-2 animate-sparkle" />
                    View My Work
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center text-lg">
                    <FaZap className="w-5 h-5 mr-2 group-hover:animate-bounce" />
                    Get In Touch
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-center animate-fade-in-up animation-delay-3000">
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="relative">
                ...
                <FaChevronDown className="w-8 h-8 text-purple-400 animate-bounce animation-delay-200 absolute top-0" />
              </div>
            </div>
          </div>
        </section>
